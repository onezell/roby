...
Crea un sito web per un agenzia di sviluppo videogames "Attic Studio".
L'aspetto del sito web deve essere identico a https://www.febucci.com/

Identifica le pagine fondamentali di un sito di sviluppatori di videogames. 
Faranno anche dei corsi di formazione.

Il sito deve essere compatibile con Strapi per la gestione dei contenuti.
...
In Attic Studio Business Plan_Per stile visivo.pdf abbiamo lo stile da utilizzare.
